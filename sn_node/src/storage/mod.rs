...
impl DataStorage {
    ...
    pub(crate) fn exceeds_network_minimum_storage_limit(&self) -> bool {
        self.used_space.exceeds_network_minimum_limit()
    }
...
mod tests {
    ...
    async fn data_storage_basics() -> Result<(), Error> {
        ...
        let used_space = UsedSpace::new(usize::MAX, usize::MAX);
