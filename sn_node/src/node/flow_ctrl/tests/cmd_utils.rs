...
impl ProcessAndInspectCmds {
    ...
    pub(crate) async fn next(&mut self, node: &mut MyNode) -> crate::node::error::Result<Option<&Cmd>> {
    ...
    pub(crate) async fn process_all(&mut self, node: &mut MyNode) -> crate::node::error::Result<()> {
